...
if (isset($_POST['search'])) {
    $search_query ="SELECT *,(SELECT AVG(rate_course_value) FROM rating r WHERE (r.cour_id = c.cour_id)) AS avg_rating FROM course c, teacher t WHERE (c.teac_id = t.teac_id) AND (cour_name LIKE '%".$_POST['search']."%')";
...
<head>
    ...
    <title>Monitor Course</title>
</head>
<body>
    <?php include("admin-nav.php")?>
    <section class="show-all-course">
        <div class="title-and-search">
            <p class="show-course">Courses</p>
        ...
        <div class="course-card-list-all">
           ...
           <a class="course-link" href="admin-course-content.php?cid=<?php echo $row['cour_id']?>">
            ...
            <div class="page-links-div">
                ...
                ?>
                    <a class="page-links" href="admin-course.php?page=<?php echo $page;?>"><?php echo $page;?></a>
