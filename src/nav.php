...
$profile_pic = $row['stud_profile_picture'];
?>
...
<body>
    <section class="top-nav-bar">
        <div class="left-nav">
            <a id="learneasy-logo" href="student-home.php"><img src="Images/Learneasy-top-logo.png" alt=""></a>
            <nav>
                <ul class="main-menu">
                    <li><a href="course-category.php?get_category=all">Course <i class="fas fa-caret-down"></i></a>
                        <ul class="sub-menu">
                    ...
                    <li><a href="Student-QuizHomepage.php">Quiz</a></li>
                ...
                <ul class="my-account">
                    <li><a href="">My Account <i class="fas fa-caret-down"></i></a>
                        <ul class="account-sub">
                            ...
                            <li><a href="setting.php" title="Settings">Settings</a></li> 
