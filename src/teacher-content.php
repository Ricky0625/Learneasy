...
$sql = "SELECT * FROM student where stud_username = '$logged_teac' LIMIT 1";
...
<body>
    ...
    <div class="course-content-div">
        <div class="course-name-edit-btn">
            <p class="content-course-name"><?php echo $cour_name;?></p>
            <button onclick="location.href='edit-course.php?cour_id=<?php echo $cid?>'">Edit Course</button>
        </div>
