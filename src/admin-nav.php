        ...
        <div class="left-nav">
            ...
            <nav>
                <ul class="main-menu">
                    ...
                    <li><a href="admin-course.php">Courses&nbsp;<i class="fas fa-caret-down"></i></a>
                        <ul class="sub-menu">
                            <li><a href="admin-course-category.php?get_category=business">Business</a></li>
                            <li><a href="admin-course-category.php?get_category=design">Design</a></li>
                            <li><a href="admin-course-category.php?get_category=it">IT</a></li>
                        </ul>
                    </li>
                    <li><a href="">Report&nbsp;<i class="fas fa-caret-down"></i></a>
                        <ul class="sub-menu">
                            <li><a href="admin-course-report.php">Course</a></li>
                            <li><a href="admin-student-report.php">Student</a></li>
                        </ul>
                    </li>
                </ul>
            </nav>
