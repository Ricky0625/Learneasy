...
$sql = "SELECT * FROM teacher WHERE teac_username = '$username' LIMIT 1";
$result = mysqli_query($conn, $sql);
$row = mysqli_fetch_array($result);
$join_date = strtotime($row['teac_join_date']);
$teac_join_date = date('Y/m/d', $join_date);
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <div class="page-padding">
            ...
            <div class="setting-page">
                <section class="setting-left">
                    ...
                    <div class="setting-flex-row">
                        <span class="acc-info-label">Name:</span><span><?php echo $row['teac_first_name'] ?> <?php echo $row['teac_last_name'] ?></span>
                    </div>

                    <div class="setting-flex-row">
                            <span class="acc-info-label">Username:</span><span><?php echo $row['teac_username'] ?></span>
                    </div>
                    <div class="setting-flex-row">
                        <span class="acc-info-label">Email:</span><span><?php echo $row['teac_email'] ?></span>
                    </div>
                    <div class="setting-flex-row">
                        <span class="acc-info-label">Join Date:</span><span><?php echo $teac_join_date; ?></span>
                    </div>
                </section>
                ...
                <section class="setting-right">
                    ...
                    <div class="setting-content">
                        ...
                        <div id="Email" class="tabcontent">
                            <form method = "POST" action = "update-teac-email.php" >
                                <p class="setting-title">Change Email Address</p>
                                <div class="flex-col">
                                    <span class="small-title">Current Email Address</span>
                                    <input type="email" name="teac-cur-email" class="input-field" value="<?php echo $row['teac_email'] ?>" readonly="">
                                </div>
                                <div class="flex-col">
                                    <span class="small-title">New Email Address</span>
                                    <input type="email" name="teac-new-email"class="input-field" required="">
                                </div>
                                <div class="flex-col">
                                    <div class="flex-col">
                                    ...
                                    <input type="password" name="teac-password" class="input-field" required="">
                                </div>
                                <input type="submit" value="Update" name="teac-email-update" class="setting-btn">
                            </form>
                        </div>

                        <div id="Password" class="tabcontent">
                            <form method = "POST" action = "update-teac-password.php" >
                                <p class="setting-title">Change Password</p>
                                <div class="flex-col">
                                    <span class="small-title">Current Password</span>
                                    <input type="password" name="teac-cur-pass" class="input-field" required="">
                                </div>
                                <div class="flex-col">
                                    <span class="small-title">New Password</span>
                                    <input type="password" name="teac-new-pass"class="input-field" required="">
                                </div>
                                <div class="flex-col">
                                    <span class="small-title">Confirm New Password</span>
                                    <input type="password" name="teac-conf-pass"class="input-field" required="">
                                </div>
                                <input type="submit" name="teac-pass-update" value="Update" class="setting-btn"> 
                            </form>
                        </div>

                        <div id="Account" class="tabcontent">
                            <form method = "POST" action = "delete-teac.php" >
                                <p class="setting-title">Delete Account</p>
                                <div class="flex-row" style="border-bottom: none;">
                                    <img id="profile-pic" src="Images/<?php echo $row['teac_profile_picture'] ?> " alt="">
                                    <div class="flex-col" style="margin: 0; margin-left: 10px;">
                                        <span id="fullname"><?php echo $row['teac_first_name'] ?> <?php echo $row['teac_last_name'] ?></span>
                                        <span id="username">@<?php echo $row['teac_username'] ?></span>
                                    </div>
                                </div>
                                ...
                                <input type="submit" value="Delete My Account" name="teac-acc-delete" class="setting-btn delete-acc">
                            </form>
                        </div>
                    </div>
