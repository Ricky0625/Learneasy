<?php
$logged_user =  $_SESSION['adm_username'];
$sql_user = "SELECT * FROM admin WHERE adm_username = '$logged_user'";
...
<head>
  ...
  <link rel="stylesheet" href="admin-course-tabs.css">
  <link rel="stylesheet" href="admin-rating.css">
...
<body>
      ...
      <div class="flexbox-for-about">
        ...
        <div class="about-teacher">
          <div class="profile-and-name">
            ...
            <a href="admin-view-teacher-profile.php?tid=<?php echo $tid?>" id="teacher-name" target="_NEW"><?php echo $teac_first_name;?> <?php echo $teac_last_name;?></a>
          </div>
      ...
      ?>
        ...
        <div id="rating-modal" class="rating-modal-overall">
            ...
            <div class="rating-modal-content">
                ...
                <form method = "POST" name="rating-modal-form" action = "admin-insert-update-rating.php"  >
          ...
          <div class="question-template">
            ...
            <div class="post-info">
              ...
              <div class="post-flex comment-link">
                <a href="admin-discussion.php?qid=<?php echo $ques_id?>&cid=<?php echo $cid?>" title="Click to view all replies."><i class="fas fa-comment-alt"></i></span></a>
              </div>  
            </div>
          </div>
 ...
 <?php
            //Display the selected course detail
            $quizsql = "SELECT * FROM course c, quiz q WHERE (c.cour_id = q.cour_id) AND (q.cour_id = '$cid')";//Need to connect to quiz_question, course and teacher
            $quizresult = mysqli_query($conn, $quizsql);
            if(mysqli_num_rows($quizresult) > 0){
            while ($quizrow = mysqli_fetch_array($quizresult)){
            ?>
            <div class="quiz-card">
              <a class="link-to-course"href="admin-QuizForm.php?cid=<?php echo $cid; ?>">
                <div class="quiz-pic-qs">
                  <img src="Images/<?php echo $quizrow['cour_cover']; ?>" alt="">
                  <span class="quiz-ques-num">5 Qs</span>
                </div>
                <div class="quiz-name-owner">
                  <p class="quiz-name"><?php echo $quizrow['quiz_title']; ?></p>
                  <div class="quiz-owner-author">
                    <img class="quiz-owner" src="Images/<?php echo $teac_profile;?>" alt="">
                    <span class="quiz-author"><?php echo $teac_first_name;?> <?php echo $teac_last_name;?></span>
                  </div>
                </div>
              </a>
            </div>
