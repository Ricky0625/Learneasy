...
<body>
    ...
    <section class="teacher-register">
        <form action="" id="tr-form">
            <div class="flex-row">
                <div class="flex-label-input">
                    <span class="tr-label">First Name :</span>
                    <input type="text" class="tr-input-short" required>
                </div>
            ...
            <div class="flex-label-input top-space">
                ...
                <input type="text" class="tr-input" required>
            </div>
            <div class="flex-label-input top-space">
            ...
            <div class="flex-label-input top-space">
                ...
                <div class="password-showhide">
                    <input type="password" class="tr-input" id="password-field" required>
            ...
            <div class="flex-label-input top-space">
                ...
                <div class="password-showhide">
                    <input type="password" class="tr-input" id="conpassword-field" required>
            ...
            <div class="flex-label-input top-space">
                ...
                <input type="file" id="real-file" hidden="hidden" accept=".docx,.pdf" required="required">
